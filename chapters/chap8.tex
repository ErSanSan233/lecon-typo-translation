...
\begin{enumerate}[resume]
    \item Jean-Pierre \textsc{Lacroux}, Orthotypographie, 2007, <\linkk{http://www.orthotypographie.fr}{http://www.orthotypo\linebreak graphie.fr}>. \label{ref5}
\end{enumerate}
...
\begin{enumerate}[resume]
    ...
    \item Éric \textsc{Martini}, \emph{Petit guide de typographie}, Glyphe, Paris, 2003 ; <\linkk{http://www.glyphe.com/typo.pdf}{http://www.\linebreak glyphe.com/typo.pdf}>. \label{ref7}
\end{enumerate}

再比如一些通用的排印学作品，比如[\ref{ref21}]、[\ref{ref23}]，它们通常给出了基本的规则。此外，还可以查询网络上的以下讨论：

\begin{itemize}
    \item Liste typo : <\link{https://www.irisa.fr/wws/info/typographie}> ；
    \item Forum langue française : <\link{http://langue-fr.net/}> ；
    \item Blog des correcteurs du \emph{Monde} (« Langue sauce piquante ») :
    <\linkk{http://correcteurs.blog.lemonde.fr/}{http://correc\linebreak teurs.blog.lemonde.fr/}>。
\end{itemize}
...
\begin{enumerate}[resume]
    ...
    （针对英文的参考资料。它有一个问答网站 [问题类似于\emph{URL的换行是否应当使用硬空格？}] ，见<\link{http://www.chicagomanualofstyle.org/home.html}>。）\label{ref8}
    \item Dominique \textsc{Lacroix}, \emph{Mémento de typographie anglaise à l'usage de rédacteurs francophones}, <\linkk{http://www.infotheque.info/cache/9491/www.panamo.com/RESS/anglais.html}{http://www.infotheque.info/cache/9491/www.panamo.com\linebreak /RESS/anglais.html}>.\\
    （很好的页面，带有很好的链接。）\label{ref9}
    \item Office des publications de l'Union européenne, Code de rédaction interinstitutionnel : <\link{http://publications.eu.int/code/fr/fr-000300.htm}>.\label{ref10}
\end{enumerate}
...
\begin{enumerate}[resume]
    \item Organisation intergouvernementale de la convention du mètre, \emph{Le Système international d'unités (SI)}, édité par le BIPM, pavillon de Breteuil, Sèvres, 8e édition, 2003. Voir aussi <\link{http://www1.bipm.org/fr/si/si\_brochure/}>. \label{ref11}
    \item Michel Dubesset, \emph{Le manuel du Système international d'unités}, Éditions Technip, 2000.\\
    （非常详尽，带有量纲式。）\label{ref12}
    \item \emph{International System of Units (SI)}, The Physics Laboratory of NIST, <\linkk{http://physics.nist.gov/cuu/Units/index.html}{http://\linebreak physics.nist.gov/cuu/Units/index.html}>.
...
也可以参见``langue française''论坛网站：<\link{http://www.langue-fr.net/}>。
...
也请参见<\link{http://jacques-andre.fr/faqtypo/biblio.pdf}>中列出的参考资料。
